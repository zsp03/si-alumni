...
export default function Home(props) {
    return (
        ...
        >
            ...
            <div className="py-10">
                <div className="max-w-20xl mx-auto sm:px-6 lg:px-8 flex justify-between">
                    {/* berita*/}
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden">
                        {/* proifl */}
                        <div className="flex flex-col justify-center max-w-xs p-6 shadow-md  dark:bg-gray-900 dark:text-gray-100">
                            <img
