    ...
    <section class="flex flex-col w-full shadow-md">
                        ...
                        <div class="flex flex-col gap-3 text-center sm:text-left animate-in slide-in-from-bottom duration-700">
                            ...
                            <div class="lg:mt-20 flex flex-col gap-4 items-center sm:items-start">
                                ...
                                <a href="{{ route('database') }}"
                                    class="btn shadow-md shadow-gray-800 border-transparent normal-case font-semibold text-lg transition-colors bg-cyan-700 hover:bg-cyan-800 hover:border-transparent rounded-md w-60 h-10 text-white text-hover">
                                    Cari Alumni
                                </a>
                            </div>
                        </div>
                        <div class="flex flex-col mb-20 items-center">
                            <x-profile-card :user="Auth::user()" class="animate-in slide-in-from-right duration-700 bg-opacity-80 shadow-lg shadow-gray-800">
                                <a href="{{ route('profile.show') }}"
                                   class="btn rounded-lg min-h-[40px] h-fit bg-red-700 hover:bg-red-800 normal-case border-none text-sm font-medium text-white shadow-md">
                                   Perbarui Profil
                                </a>
                            </x-profile-card>
                        </div>
        ...
        <div class="flex flex-col sm:flex-row">
            ...
            <div class="flex-1 bg-gray-100">
                <div class="flex flex-col gap-6 justify-center h-full max-w-6xl p-6 sm:p-8 sm:pl-16 md:p-20">
