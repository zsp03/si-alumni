<x-app-layout>
    ...
    <section class="flex bg-gray-100">
        <div class="flex flex-1 h-[85vh] border shadow p-4">
            <div class="flex flex-col justify-between items-center w-16 rounded-l-md bg-gray-200">
            ...
            <div class="w-1/3 bg-gray-100 flex flex-col overflow-y-auto bg-white border-r">
                <div class="p-4 w-full z-30 flex flex-col gap-2 shadow">
                    <span class="font-semibold text-3xl">Inbox</span>
                ...
                <div class="flex flex-col overflow-y-auto">
                    <div class="border-l-2 border-blue-500 bg-blue-100 space-y-2 p-3">
                        <div class="flex flex-row items-center gap-2">
                            ...
                            <div class="w-full flex flex-col">
                                <span class="text-xs font-semibold text-gray-600"> Maylinda Eka </span>
                                <strong class="flex-grow font-bold">Lorep Ipsum</strong>
                            </div>

                            <div class="whitespace-nowrap justify-end text-sm text-gray-600">5 Hari</div>
                        </div>
                    ...
                    <div class="border-b hover:bg-gray-100 p-3">
            ...
            <div class="hidden lg:flex w-2/3 flex-col bg-white overflow-y-auto border-b rounded-r-md">
                <div class="h-20 flex justify-between items-center border-b p-4">
                    <div>
