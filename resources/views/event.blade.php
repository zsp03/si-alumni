<x-app-layout>
    ...
    <section class="mt-7 dark:bg-gray-800 dark:text-gray-100 bg-white">
        <div class="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
            <a rel="noopener noreferrer" href="{{ route('event-post') }}" class="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-900">
